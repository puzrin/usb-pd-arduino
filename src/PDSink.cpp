...
PDSink::PDSink(PDController* controller) :
...
void PDSink::setBusPowered(bool busPowered) {
...
typename PDSink::ErrorCode PDSink::requestPowerCore(int voltage, int maxCurrent) {
